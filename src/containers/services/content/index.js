                ...
                <div className="row post_row">
                        ...
                        <div className="post">
                            <div className="img">
                                <a href="blogpost.html">
                                    <img src="images/blog1.png" alt="" className="img-responsive" />
                                </a>
                            </div>
                            <div className="text">
                                <h5><a href="blogpost.html">Clean Canvas beautiful responsive theme.</a></h5>
                                <span className="date">Wed, 12 Dec.</span>
                                <p>
                            ...
                            <a className="plus_wrapper" href="blogpost.html">
                                <span>&#43;</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-4">
                        <div className="post">
                            <div className="img">
                                <a href="blogpost.html">
                                    <img src="images/blog2.png" alt="" className="img-responsive" />
                                </a>
                            </div>
                            <div className="text">
                                <h5><a href="blogpost.html">Clean Canvas beautiful responsive theme.</a></h5>
                    ...
                    <div className="col-sm-4">
                        <div className="post last">
                            <div className="img">
                                <a href="blogpost.html">
                                    <img src="images/blog3.png" alt="" className="img-responsive" />
                                </a>
                            </div>
                            <div className="text">
                                <h5><a href="blogpost.html">Clean Canvas beautiful responsive theme.</a></h5>
